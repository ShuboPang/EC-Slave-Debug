...
var huacheng_alarm ={
    1 : qsTr("cErr_erEmergency"),
    2 : qsTr("cErr_SD_OC1"),
    3 : qsTr("cErr_SD_OC2"),
    4 : qsTr("cErr_EXTERNAL_VDC_OFF"),
    5 : qsTr("cErr_LOD_OL1"),
    6 : qsTr("cErr_LOD_OL2"),
    7 : qsTr("cErr_AXIS1_INIT"),
    8 : qsTr("cErr_AXIS2_INIT"),
    9 : qsTr("cErr_AXIS1_PHA_FAIL"),
    10: qsTr("cErr_AXIS2_PHA_FAIL"),
    11: qsTr("cErr_VDC_UV"),
    12: qsTr("cErr_VDC_OV"),
    13: qsTr("cErr_OVSPD1"),
    14: qsTr("cErr_OVSPD2"),
    15: qsTr("cErr_Over_Heat"),
    16: qsTr("cErr_EEP_ER1")  ,
    17: qsTr("cErr_EEP_EF2")  ,
    18: qsTr("cErr_POSE1")    ,
    19: qsTr("cErr_POSE2")    ,
    20: qsTr("cErr_ECD1_ER")  ,
    21: qsTr("cErr_SPD1_ME")  ,
    22: qsTr("cErr_ECD1_INIT"),
    23: qsTr("cErr_EMS1")     ,
    24: qsTr("cErr_EXTERNAL_ERR")     ,
    25: qsTr("cErr_POS1_BUF_FULL")     ,
    26: qsTr("cErr_POS2_BUF_FULL")     ,
    27: qsTr("cErr_IIC_PARAM_CHECK"),
    28: qsTr("cErr_ECD2_ER")  ,
    29: qsTr("cErr_SPD2_ME")  ,
    30: qsTr("cErr_ECD2_INIT"),
    31: qsTr("cErr_ClrAlarmFrequently"),
    32: qsTr("cErr_IIC_NEED_RECOVER"),
    33: qsTr("cErr_ECAT_ER"),
    34: qsTr("cErr_BATTERY1_ER"),
    35: qsTr("cErr_BATTERY2_ER"),
    36: qsTr("cErr_BATTERY1_WARNING"),
    37: qsTr("cErr_BATTERY2_WARNING"),
    38: qsTr("cErr_Motor1_Diff"),
    39: qsTr("cErr_Motor2_Diff"),
    40: qsTr("cErr_Motor1_Invalid"),
    41: qsTr("cErr_Motor2_Invalid"),
    42: qsTr("cErr_Axis_1_encoder_data_is_not_updated"),
    43: qsTr("cErr_Axis_2_encoder_data_is_not_updated"),
    44: qsTr("cErr_Axis_1_encoder_multi-turn_value_error"),
    45: qsTr("cErr_Axis_2_encoder_multi-turn_value_error"),
    46: qsTr("cErr_Axis_1_power_mismatch"),
    47: qsTr("cErr_Axis_2_power_mismatch"),
    48: qsTr("cErr_Axis-1_config_set_error"),
    49: qsTr("cErr_Axis-2_config_set_error"),
}
